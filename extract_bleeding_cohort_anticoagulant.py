...
cohort_sample = cohort.copy()
sample_stay_ids = cohort_sample['stay_id'].tolist()

print(f"  Using FULL cohort: {sample_size} stays for feature extraction")
...
vital_itemids = {
    ...
    220210: 'resp_rate',
    223761: 'temperature',
    223762: 'temperature',  # Alternative itemid
    220277: 'spo2',
    220739: 'gcs',
    223900: 'gcs',  # GCS verbal
    223901: 'gcs',  # GCS motor
    226512: 'weight',
    224639: 'weight',  # Alternative
    226730: 'height',
    226707: 'height'   # Alternative
}
...
lab_itemids = {
    # Hematology
    51222: 'hemoglobin',
    50811: 'hemoglobin',  # Alternative
    51221: 'hematocrit',
    50810: 'hematocrit',  # Alternative
    51265: 'platelet',
    51704: 'platelet',    # Alternative
    51301: 'wbc',
    51755: 'wbc',         # Alternative
    
    # Coagulation
    51237: 'inr',
    51275: 'aptt',
    51274: 'pt',          # ADDED: Prothrombin time
    
    # Chemistry
    50912: 'creatinine',
    51006: 'bun',
    50983: 'sodium',
    50824: 'sodium',      # Alternative
    50971: 'potassium',
    50822: 'potassium',   # Alternative
    50931: 'glucose',
    50809: 'glucose',     # Alternative
